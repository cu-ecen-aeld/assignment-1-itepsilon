...
void test_validate_my_username()
{
    ...
    const char* username_from_config = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(username, username_from_config, "Username should match the username in config file");
}